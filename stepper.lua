...
bindWithRepeat({"ctrl", "option"}, "home", function() focus.focusDirection("left") end)
bindWithRepeat({"ctrl", "option"}, "end", function() focus.focusDirection("right") end)
bindWithRepeat({"ctrl", "option"}, "pageup", function() focus.focusDirection("up") end)
bindWithRepeat({"ctrl", "option"}, "pagedown", function() focus.focusDirection("down") end)
...
bindWithRepeat({"ctrl", "option", "cmd"}, "home", function() focus.focusScreen("left") end)
bindWithRepeat({"ctrl", "option", "cmd"}, "end", function() focus.focusScreen("right") end)
bindWithRepeat({"ctrl", "option", "cmd"}, "pageup", function() focus.focusScreen("up") end)
bindWithRepeat({"ctrl", "option", "cmd"}, "pagedown", function() focus.focusScreen("down") end)
